...
class XianyuSearchRepairAdapter:
    """闲鱼搜索/列表 DOM 修复插头。"""
    ...
    async def evaluate_extract(
        ...
        *,
        ...
        raw = await page.evaluate(ex.EXTRACT_JS, arg)
    ...
    def is_auth_payload(self, payload: dict[str, Any]) -> bool:
        return bool(payload.get("requiresAuth"))
