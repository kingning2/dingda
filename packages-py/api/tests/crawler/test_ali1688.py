...
from crawler.sources.ali1688.compare import select_top
from crawler.sources.ali1688.extractor import item_from_api, items_from_api
from crawler.sources.ali1688.link import parse_product_ref
...
def test_compare_products_mocked() -> None:
    ...
    async def _run() -> None:
        with patch(
            "crawler.sources.ali1688.compare.Ali1688Crawler"
        ) as crawler_cls:
            instance = AsyncMock()
