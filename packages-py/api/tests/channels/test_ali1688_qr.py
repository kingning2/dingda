...
from channels.ali1688.channel import Ali1688QrChannel, Ali1688LoginRuntime
from channels.ali1688.login import is_plausible_ak
...
def test_png_looks_like_qr_rejects_blank_and_wide() -> None:
    ...
    from channels.ali1688.login import _png_looks_like_qr
