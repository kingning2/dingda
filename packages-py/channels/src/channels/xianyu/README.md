...
- `run_forever` — 常驻重连（产品侧；CLI skill 的 IM watch 用短时 `collect_events`）
...
无。闲鱼**搜索页 DOM** 在 [../../crawler/sources/xianyu/README.md](../../../../crawler/src/crawler/sources/xianyu/README.md)。
