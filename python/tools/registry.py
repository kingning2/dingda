...
def _register_builtins() -> None:
    ...
    from tools.alibaba.bindings import make_alibaba_search_tool
    from tools.knowledge.bindings import make_knowledge_retrieve_tool
    from tools.web.bindings import make_web_fetch_tool, make_web_scrape_tool
    from tools.xianyu.bindings import make_xianyu_search_tool
