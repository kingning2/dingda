...
from runtimes.knowledge.runtime import get_knowledge_runtime
from runtimes.langgraph import LangGraphRuntime
from runtimes.worker import WorkerRuntime
from runtimes.wss.runtime import get_wss_runtime
...
class AppRuntime:
    ...
    def status(self) -> dict[str, Any]:
        return {
            ...
            "children": {child.name: child.status() for child in self._children},
        }
