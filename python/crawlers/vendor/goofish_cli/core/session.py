...
from crawlers.vendor.goofish_cli.core.crypto import decrypt_cookies, encrypt_cookies
from crawlers.vendor.goofish_cli.core.errors import AuthRequiredError
from crawlers.vendor.goofish_cli.core.sign import generate_device_id
...
def _bootstrap_from_browser() -> tuple[str, dict[str, str]]:
    ...
    from crawlers.vendor.goofish_cli.core.browser_cookie import extract_goofish_cookies
