...
from crawlers.vendor.goofish_cli.core import Strategy, command
from crawlers.vendor.goofish_cli.core.errors import AuthRequiredError
from crawlers.vendor.goofish_cli.core.session import DEFAULT_COOKIE_PATH, write_cookies_json
...
def login(
    ...
    *,
    ...
    if qr:
        ...
        from crawlers.vendor.goofish_cli.core.qr_login import login_via_qr
...
def _pull_from_browser(browser: str) -> tuple[dict[str, str], str]:
    from crawlers.vendor.goofish_cli.core.browser_cookie import (
        BrowserCookieError,
        available_browsers,
