...
wheel 的 `goofish_cli/_bundled_skills/` 下；运行时用 `crawlers.vendor.goofish_cli.__file__` 拿
...
import crawlers.vendor.goofish_cli
...
def _bundle_root() -> Path:
    ...
    pkg_dir = Path(crawlers.vendor.goofish_cli.__file__).resolve().parent
