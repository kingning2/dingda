...
from dingda_sidecar.crawlers.core.login.helpers import has_login_cookie, to_qr_data_url
...
class Ali1688Qrcode(QrcodeLogin):
    ...
    async def _login_progress(
        ...
        from dingda_sidecar.crawlers.core.login.helpers import login_progress_from_text

        return login_progress_from_text(page_text)

    async def _collect_login_page_text(self, page: Any) -> str:
        from dingda_sidecar.crawlers.core.login.helpers import collect_page_text
