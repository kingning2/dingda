...
from dingda_sidecar.crawlers.vendor.goofish_cli.core.session import USER_AGENT, Session
from dingda_sidecar.crawlers.vendor.goofish_cli.core.sign import generate_sign
    ...
    *,
    ...
    try:
        ...
        if not (_auto_refresh and _is_recoverable_auth_error(e)):
            raise
        from dingda_sidecar.crawlers.vendor.goofish_cli.core.refresh import is_enabled, refresh_cookies_via_browser
        if not is_enabled():
            raise
