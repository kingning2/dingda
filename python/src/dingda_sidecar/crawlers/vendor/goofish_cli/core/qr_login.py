...
from dingda_sidecar.crawlers.vendor.goofish_cli.core.session import resolve_cookie_path, write_cookies_json
...
async def _login_via_qr_async(timeout: int) -> dict[str, str]:
    ...
    from dingda_sidecar.crawlers.vendor.goofish_cli.core.browser import goofish_page
