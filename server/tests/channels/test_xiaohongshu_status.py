...
from src.channels.xiaohongshu.status import LOGIN_CHANNEL_SELECTOR, probe
...
def test_probe_logged_in() -> None:
    ...
    with patch("src.channels.xiaohongshu.status.get_browser_manager", return_value=manager):
