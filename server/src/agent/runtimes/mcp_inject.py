...
设计说明：
    ...
    - 对齐原 Tauri ``runtime/mcp``：``uv run --directory <server> dingda-mcp``
    ...
    *,
    ...
    if mode == "codex-mcp":
        ...
        override = (
            ...
            f'"command"="uv","args"=["run","--directory","{server}","dingda-mcp"],'
