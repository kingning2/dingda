...
使用示例：
    python -m src.tools.validate_cli --selectors '{"price":"[class*=price]"}'
    python -m src.tools.validate_cli --selectors @selectors.json
"""
...
from src.tools.validate import ValidateInput, run_validate
