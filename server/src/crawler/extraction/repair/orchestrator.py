...
from src.crawler.extraction.fingerprint import (
    best_node_for_selector,
    nodes_from_tree,
    relocate_section,
    save_fingerprint,
)
from src.crawler.extraction.repair import gates
from src.crawler.extraction.repair.bridge import ValidationBridge
from src.crawler.extraction.repair.dump import dump_dom_tree
from src.crawler.extraction.repair.persist import persist_patch
from src.crawler.extraction.repair.types import (
    DomPatch,
    DomSnapshot,
    ...
    *,
    ...
    try:
        ...
        for round_i in range(1, rounds + 1):
            ...
            from src.cli.repair.propose import propose_dom_patch
