...
//! 闲鱼 bootstrap 通过 [`crate::command::AccountQrHandle::post_login`] 写入。
//!
//! 作者：Xiaoman
//! 创建时间：2026-08-22

use crate::command::AccountHandle;
use crate::command::AccountQrHandle;
use crate::contracts::DingDaResult;
use crate::servers::shared::{InMemoryAccountStore, SqliteBusinessDb};
