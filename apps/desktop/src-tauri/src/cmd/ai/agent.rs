...
pub async fn agent_reply(
    ...
    let response = crate::core::manager::python::routes::agent_reply::call(&client, request.into())
        .await
...
impl From<AgentReplyRequestDto>
    for crate::core::manager::python::routes::agent_reply::AgentReplyRequest
{
