...
//!
//! 壳层组合：`InMemoryRiskStore` → `crate::core::domain::risk::RiskService`。

use crate::cmd::IpcResponse;
use crate::core::domain::risk::{RiskConfig, RiskLogPage, RiskLogQuery, RiskService};
use crate::feat::xianyu::persist::InMemoryRiskStore;
...
) -> crate::contracts::DingDaResult<IpcResponse<crate::core::domain::risk::RiskTodaySuccessRate>> {
    let service = RiskService::new(state.store.as_ref());
