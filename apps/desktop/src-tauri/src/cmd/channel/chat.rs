...
use crate::core::manager::python::routes::xianyu_message_headinfo::{self, MessageHeadinfoRequest};
...
pub async fn channel_fetch_history(
    ...
    let my_unb = repo
        ...
        .and_then(|account| {
            let cookie_list = crate::core::store::cookies::parse_credential(&account.credential);
