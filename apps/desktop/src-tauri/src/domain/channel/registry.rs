...
use crate::domain::channel::capabilities::{
    builtin_descriptors, PlatformCapabilities, PlatformDescriptor,
};
use crate::domain::channel::{ChannelKind, ChannelProtocol};
...
mod tests {
    ...
    fn descriptors_include_capability_lists() {
        ...
        #[cfg(platform_xianyu)]
        {
            ...
            assert!(xianyu
                .capabilities
                .has(crate::domain::channel::capabilities::PlatformCapability::Coupon));
        }
    }
}
