...
//!
//! 壳层组合：`InMemoryOrderStore` → `crate::servers::domain::order::OrderService`。

use crate::command::IpcResponse;
use crate::servers::domain::order::{DeliveryInfoUpdate, Order, OrderService, OrderStatus};
...
pub fn order_update_delivery(
    ...
    let update = DeliveryInfoUpdate {
        ...
        delivery_method: crate::servers::domain::order::DeliveryMethod::from_str(
